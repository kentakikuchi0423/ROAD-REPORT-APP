...
<head>
  ...
  <title>プライバシーポリシー - ${BRANDING.appName}</title>
  <style>
    body {
    ...
    .disclaimer { background: #fff3cd; border-left: 4px solid #ffc107; padding: 0.6rem 1rem; margin: 1rem 0; font-size: 0.9rem; }
...
<body>
  ...
  <p>
    ${BRANDING.developer}（個人、以下「開発者」）は、${BRANDING.appName}（以下「本アプリ」）において
    収集する個人情報を以下のとおり取り扱います。
  </p>

  <h2>1. 収集する情報</h2>
  <p>本アプリでは、道路破損の通報処理に必要な以下の情報を収集します。</p>
  <ul>
  ...
  <p>
    ...
    第三者に提供しません。なお、道路修繕に関する情報を大洲市へ転送する場合がありますが、
  ...
  <p>
    ...
    通報情報は対応完了後も保持し、開発者の管理者が削除するまで保管します。
    不正アクセスや情報漏えいを防ぐため、アクセス制限・HTTPS 通信・認証を実施します。
  </p>

  <h2>5. LINE サービスについて</h2>
  <p>
    本アプリは LINE 株式会社が提供するメッセージングプラットフォームを利用します。
  ...
  <h2>7. お問い合わせ</h2>
  <p>本ポリシーおよびアプリに関するお問い合わせは、下記の開発者までご連絡ください。</p>
  <p>
    開発者：${BRANDING.developer}<br>
    メール：<a href="mailto:${BRANDING.contactEmail}">${BRANDING.contactEmail}</a>
  </p>

  <p class="meta">
    ${BRANDING.appName}（個人開発）<br>
    制定：2026年3月
  </p>
</body>
</html>
